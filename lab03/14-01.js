...
app.get('/', (req, res) => { res.sendFile(staticDir + 'index.html'); });
 ...
 app.get(prefix + '/faculties',                   (req, res) => selectService.getFaculties(res))
    ...
    .get(prefix + '/auditoriumstypes',             (req, res) => selectService.getAuditoriumTypes(res))
    ...
    .get(prefix + '/fluent/:faculty_id',          (req, res) => otherService.getPulpitsByFacultyFluent(res, req.params['faculty_id']));
